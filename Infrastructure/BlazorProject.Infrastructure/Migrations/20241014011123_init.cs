        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DefaultRate = table.Column<decimal>(type: "decimal(5,3)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceLineTaxes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvoiceLineTaxes_InvoiceLines_InvoiceLineId",
                        column: x => x.InvoiceLineId,
                        principalTable: "InvoiceLines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceLineTaxes_Taxes_TaxId",
                        column: x => x.TaxId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceLines_ItemId_InvoiceId",
                table: "InvoiceLines",
                columns: new[] { "ItemId", "InvoiceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceLineTaxes_InvoiceLineId_TaxId",
                table: "InvoiceLineTaxes",
                columns: new[] { "InvoiceLineId", "TaxId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceLineTaxes_TaxId",
                table: "InvoiceLineTaxes",
                column: "TaxId");
